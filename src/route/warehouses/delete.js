...
class DeleteWarehouseComponent extends Component {
    ...
    constructor() {
        ...
        this.state = {
            ...
            tooltopMessage: 'Almacen eliminado satisfactoriamente',
    ...
    delete = async () => {
        ...
        let o = await fetch('http://localhost:4200/warehouses/'+this.props.data.id, {
            method: 'DELETE',
            mode: 'cors',
            cache: 'default',
            headers: {
            ...
            .then(response => {
               ...
               console.log(response)
                if (response.status == 200 || response.status == 202) {
                    this.setState({ openTooltip: true, tooltopMessage: 'Almacen eliminado satisfactoriamente.', tooltopSeverity: 'success' })
                    this.handleToggle();
                    this.props.edited();
                } else {
        ...
        return (
            ...
            <Fragment>
                ...
                <Dialog
                    ...
                    <DialogContent>
                        <DialogContentText id="alert-dialog-description">Eliminar el registro asociado al NIT <b>{this.props.data.nit}</b> lo borrará permanenetemente.</DialogContentText>
                    </DialogContent>
                    <DialogActions>
...
export default DeleteWarehouseComponent